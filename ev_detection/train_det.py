...
from tools.tool_report import tool_report
...
from utils.loss import ComputeLoss, ComputeLossOTA, ComputeLossAuxOTA, ComputeXLoss
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if RANK in {-1, 0}:
                ...
                callbacks.run('on_train_batch_end', model,ni, imgs, targets, paths, loss_items)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--mode', type=str, default='yolov5', help='yolo   :[yolov3, yolov4, yolov5, yolor, yolov5-lite]'
                                                                  'yolov7 :[yolov7, ]'
