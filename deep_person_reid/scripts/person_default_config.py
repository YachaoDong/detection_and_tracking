...
def get_default_config():
    ...
    cfg.model.load_weights = '/project/train/src_repo/detection_and_tracking/model_file/osnet_ain_ms_m_c.pth.tar'  # path to model weights
    ...
    cfg.data = CN()
    cfg.data.type = 'image'
    cfg.data.root = '/home/data/person_data/'  #/home/data/person_data/
    cfg.data.sources = ['person']
    cfg.data.targets = ['person']
    ...
    cfg.data.transforms = ['random_flip', 'color_jitter']  # data augmentation
    cfg.data.k_tfm = 1 # number of times to apply augmentation to an image independently
    cfg.data.norm_mean = [0.485, 0.456, 0.406]  # default is imagenet mean
    cfg.data.norm_std = [0.229, 0.224, 0.225]  # default is imagenet std
    cfg.data.save_dir = '/project/train/models/reid/'  # path to save log
    ...
    cfg.sampler.num_instances = 8  # number of instances per identity for RandomIdentitySampler
    cfg.sampler.num_cams = 4  # number of cameras to sample in a batch (for RandomDomainSampler)
