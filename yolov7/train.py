...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,
                        default='/project/train/src_repo/detection_and_tracking/yolov7/cfg/training/person_yolov7.yaml',
                        help='model.yaml path')
    parser.add_argument('--data', type=str,
                        default='/project/train/src_repo/detection_and_tracking/yolov7/data/person.yaml',
                        help='data.yaml path')
    parser.add_argument('--hyp', type=str,
                        default='/project/train/src_repo/detection_and_tracking/yolov7/data/hyp.person.yaml',
